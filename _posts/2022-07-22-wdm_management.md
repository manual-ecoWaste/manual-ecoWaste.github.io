...
- 2.1) 단축기호: 단축기호 입력  
- 2.2) 현장명: 계약 현장명 입력  
- 2.3) 업체: 계약 주관사 선택 필요([업체 검색 팝업 호출](#업체검색))
- 2.4) 계약일: 계약일 입력  
- 2.5) 영업담당자: 영업사원 선택 가능([사용자 검색 팝업 호출](#사용자검색))  
...
2) 적재함 배치목록  
- 2.1) 추가: [현장검색](#계약검색현장검색) 팝업이 호출되어 현장 정보 선택시 적재함 배치목록에 추가  
...
3) 선택된 계약의 상세 정보  
- 3.1) 업체코드 … 버튼 클릭 시 [업체 검색](#업체검색) 팝업 호출(선택한 업체 정보 계약 상세에 자동 입력)  
...
- 2.2) 올바로-에코 코드연결 관리: 인계서 기준 [올바로-에코코드 연결 관리](#올바로-에코-코드연결-관리) 연결  
